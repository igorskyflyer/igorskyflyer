...
- `644K+` monthly requests (`951K+` quarterly) for a [**highly adopted scrollend polyfill**](https://www.jsdelivr.com/package/gh/igorskyflyer/npm-scrollend-polyfill?tab=stats)
