...
**_Igor Dimitrijević_**, commonly known as **_IgorSkyFlyer_** is a Serbian software engineer, a graduate **BSc in Software engineering** _(with Honours, 4 years)_ specializing in full-stack Web, desktop and mobile development with a strong passion for everything digital. Creator of **`Aria`** - an Adblock templates compiler, **ADBT** - Adblock template language and file format and **AdVoid** - a set of multiple efficient Adblock filter lists, **Open in Browser** - a popular (~**`200K`** of downloads) Visual Studio Code extension and many other endearing projects.  
...
1. 🔒 Closed issue [#2980](https://github.com/igorskyflyer/ad-void/issues/2980) in [igorskyflyer/ad-void](https://github.com/igorskyflyer/ad-void)
2. ❗ Opened issue [#2980](https://github.com/igorskyflyer/ad-void/issues/2980) in [igorskyflyer/ad-void](https://github.com/igorskyflyer/ad-void)
3. 🔒 Closed issue [#2979](https://github.com/igorskyflyer/ad-void/issues/2979) in [igorskyflyer/ad-void](https://github.com/igorskyflyer/ad-void)
