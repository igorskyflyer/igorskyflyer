...
<div data-no-restyle>
  ...
  <ul data-no-restyle>
    <li><a href="https://www.jsdelivr.com/package/gh/igorskyflyer/npm-scrollend-polyfill"><strong>Scrollend Polyfill</strong></a> – Powering <strong>3.72M yearly requests</strong> with +58.727% growth; ranked 7,756th on jsDelivr as a <strong>top 0.20%</strong> package.</li>
...
<div align="right"><em>Recent work</em></div>

### 🤖 Tech

- Revised and fixed the Serbian translation of [**UnigetUI**](https://github.com/Devolutions/UniGetUI) \[_awaiting release_]
