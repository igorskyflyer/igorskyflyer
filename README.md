...
- Created a repository:
  - [**igorskyflyer/dotfiles**](https://github.com/igorskyflyer/dotfiles) - a curated index of all published @igorskyflyer configuration packages; crafted for a seamless DX.
