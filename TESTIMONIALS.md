...
- [Photoshop Design &rarr; WordPress Template](#-pixel-perfect-design-from-a-photoshop-template)
...
- [ASP.NET Template Cleanup](#-fix-layout-and-clean-up-a-custom-aspnet--bootstrap-template)
- [PHP Movie Site Recovery](#️-fix-broken-php-movie-website)
- [WPF Layout Format + I/O](#-custom-wpf-layout-storage-file-format-and-importexport-features)
- [WPF Management Suite](#-custom-wpf-based-management-solution)
- [HR Senior Dev Interview Quiz](#️-hr-senior-developer-interview-quiz-creation-and-testing)
- [Custom Drag-n-Drop WPF Components](#-custom-drag-n-drop-wpf-components)
- [Legacy jQuery Site Website](#-debug-and-improve-legacy-jquery-heavy-website)
- [jQuery Bug in a WWA App](#-fix-a-jquery-error-in-a-windows-store-wwa-application)
- [Android Camera API Fix](#-fix-a-fatal-camera-api-bug-in-an-android-qr-scanner-application)
...
A detailed breakdown of these projects is available on the [**Past Work**](https://github.com/igorskyflyer/igorskyflyer/blob/main/PAST_WORK.md) page.
