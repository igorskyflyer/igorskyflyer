...
Thank you for considering a contribution to this project! Whether you're fixing bugs, suggesting improvements, writing docs, or sharing ideas – your input helps the project grow and evolve.
...
- If you're unsure, feel free to open an `issue` or discussion to explore the idea.
...
Your contribution helps maintain and improve this project — thank you for helping make it better!  
Check out [`SUPPORT.md`](./SUPPORT.md) if you need help or want to sponsor its development.
