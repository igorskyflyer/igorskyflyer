...
- Igor opened an [**issue**](https://github.com/Automattic/harper/issues/3961) at `Automattic/harper`, noting that `SentenceCapitalization` gets flagged incorrectly – `Aug 05`.
- Igor opened an [**issue**](https://github.com/Devolutions/UniGetUI/issues/5239) at `Devolutions/UniGetUI`, noting that the Cargo package `binstall` could not be identified and, hence, could not be updated successfully – `Aug 03`.
...
- Igor opened an [**issue**](https://gitlab.com/versionlens/vscode-versionlens/-/work_items/418) at `versionlens/vscode-versionlens`, noting that the UI shows stale or incorrect CodeLens commands – `Jul 01`.
- Igor opened an [**issue**](https://github.com/Devolutions/UniGetUI/issues/4942) at `Devolutions/UniGetUI`, noting that package version numbers are cut off in the main window – `Jun 17`.
- Igor opened an [**issue**](https://github.com/truelockmc/streambert/issues/60) at `truelockmc/streambert`, noting a layout shift when toggling watched status – `May 17`.
- Igor opened an [**issue**](https://github.com/Devolutions/UniGetUI/issues/4793) at `Devolutions/UniGetUI`, noting a UI state mismatch in upgradable package selection when using Avalonia mode – `May 16`.
...
- Igor opened an [**issue**](https://github.com/git/git-scm.com/issues/2154) at `git/git-scm.com`, noting that assets fail to load on the Windows installation page, likely caused by an SRI issue – `Apr 15`.
...
- Igor submitted a [**PR**](https://github.com/collinbarrett/FilterLists/pull/5151) to `collinbarrett/FilterLists`, adding [**AdVoid**](https://github.com/the-advoid/ad-void) to the ad-block filter list directory – `Sep 9`.
- Igor opened an [**issue**](https://github.com/cssbattle/forum/issues/430) at `cssbattle/forum`, noting that submission-related badges are not working – `Sep 9`.
...
- Igor opened an [**issue**](https://github.com/brave/brave-browser/issues/43170) at `brave/brave-browser`, noting that adding a specific filter list causes an infinite crash loop – `Jul 21`.
...
- Igor opened an [**issue**](https://github.com/microsoft/vsmarketplace/issues/983) at `microsoft/vsmarketplace`, noting that auto-links in an extension's README are incorrectly generated – `Aug 11`.
- Igor opened an [**issue**](https://github.com/microsoft/vscode/issues/224644) at `microsoft/vscode`, noting a discrepancy in Markdown rendering of auto-links across GitHub, Marketplace, and VS Code – `Aug 2`.
- Igor opened an [**issue**](https://github.com/withastro/starlight/issues/2127) at `withastro/starlight`, noting that creating a new project using the template fails on Windows – `Jul 12`.
- Igor reached out to a developer using his [**PostExcerpt for Astro**](https://github.com/igorskyflyer/npm-astro-post-excerpt) component and submitted a [**PR**](https://github.com/SoyCarlos/SoyCarlos.github.io/pull/15) to `SoyCarlos/SoyCarlos.github.io`, providing a complete integration of the component for their site. Another developer mentioned the `PostExcerpt` component on [**their blog**](https://chenhuijing.com/blog/creating-excerpts-in-astro/) – `Jul 11`.
- Igor claimed his [**Knowledge Panel**](https://www.google.com/search?kgmid=/g/11kc3sl0nv) on Google – `May 6`.
- Igor opened an [**issue**](https://github.com/brave/brave-browser/issues/35163) at `brave/brave-browser`, noting that the Back key/gesture cannot be used to exit the QR code scanner – `Jan 6`.
- Igor opened an [**issue**](https://github.com/brave/brave-browser/issues/35140) at `brave/brave-browser`, noting that data in `Privacy Stats` is incorrectly calculated and displayed – `Jan 4`.
...
- Igor opened an [**issue**](https://github.com/microsoft/vscode/issues/198975) at `microsoft/vscode`, noting that commit messages disappear after undoing the last commit – `Nov 23`.
- Igor opened an [**issue**](https://github.com/nodejs/node/issues/50619) at `nodejs/node`, noting that the [`Date.toLocaleString()`](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Date/toLocaleString) function produces an incorrect 24h output (`24:50` instead of `00:50`) – `Nov 8`.
- Igor opened an [**issue**](https://github.com/PlayForm/Compress/issues/206) at `PlayForm/Compress`, catching a fatal error during SSR module evaluation that caused the Astro site to crash – `Oct 22`.
- Igor opened an [**issue**](https://github.com/microsoft/vscode/issues/189574) at `microsoft/vscode`, noting that an error occurs when applying a built-in extension to all profiles – `Aug 3`.
- Igor submitted a [**PR**](https://github.com/rust-lang/rust-analyzer/pull/15290) to `rust-lang/rust-analyzer`, implementing direct debugger installation via VS Code notification command links and replacing the manual search workflow. The solution resolved an internal VS Code URI encoding limitation for string arguments, released alongside [**Rust v1.73.0**](https://thanks.rust-lang.org/rust/1.73.0/) – `Jul 20`.
- Igor created a [**discussion**](https://github.com/anuraghazra/github-readme-stats/discussions/2942) at `anuraghazra/github-readme-stats`, noting that Go is not counted in Top Languages – `Jul 15`.
- Igor opened an [**issue**](https://github.com/npm/cli/issues/6621) at `npm/cli`, noting that the provided install command fails on Windows when the scope or package name contains a dot – `Jul 2`.
- Igor opened an [**issue**](https://github.com/microsoft/winget-cli/issues/3288) at `microsoft/winget-cli`, noting that administrator privilege elevation fails to trigger when required by an installer – `May 30`.
- Igor opened an [**issue**](https://github.com/microsoft/winget-cli/issues/3248) at `microsoft/winget-cli`, noting an upgrade loop when updating Microsoft Visual C++ 2015-2019 Redistributable – `May 13`.
- Igor created a [**discussion**](https://github.com/github-linguist/linguist/discussions/6394) at `github-linguist/linguist`, noting that excluding languages works inconsistently – `Apr 28`.
- Igor opened an [**issue**](https://github.com/jonjomckay/fritter/issues/663) at `jonjomckay/fritter`, notifying the author of a fatal API bug – `Apr 21`.
- Igor submitted a [**PR**](https://github.com/you-apps/ConnectYou/pull/135) to `you-apps/ConnectYou`, translating the entire Android application to Serbian – `Apr 10`.
- Igor submitted a [**PR**](https://github.com/you-apps/TranslateYou/pull/220) to `you-apps/TranslateYou`, translating the entire Android application to Serbian – `Apr 10`.
- Igor submitted a [**PR**](https://github.com/you-apps/WallYou/pull/86) to `you-apps/WallYou`, translating the entire Android application to Serbian – `Apr 10`.
- Igor submitted a [**PR**](https://github.com/you-apps/TriviaYou/pull/97) to `you-apps/TriviaYou`, translating the entire Android application to Serbian – `Apr 10`.
- Igor submitted a [**PR**](https://github.com/you-apps/ClockYou/pull/13) to `you-apps/ClockYou`, translating the entire Android application to Serbian – `Apr 9`.
- Igor submitted a [**PR**](https://github.com/you-apps/RecordYou/pull/101) to `you-apps/RecordYou`, translating the entire Android application to Serbian – `Apr 1`.
...
- Igor's Astro components were added to the official [**astro.build**](https://astro.build/integrations/?search=igor.dvlpr) integrations page – `Dec 3 - ongoing`.
- Igor opened an [**issue**](https://github.com/microsoft/vscode/issues/163081) at `microsoft/vscode`, noting that parsing notification command links fails when multiple links are present, breaking link navigation for all users – `Oct 9`.
- Igor submitted a [**PR**](https://github.com/woocommerce/woocommerce/pull/34932) to `woocommerce/woocommerce`, fixing numerous typos he spotted while working for a client, improving DX for WooCommerce developers, released in [**WooCommerce v7.2.0**](https://developer.woocommerce.com/2022/12/14/woocommerce-7-2-0-released/) – `Oct 3`.
