...
- `~1 300%` productivity increase in [**AdVoid**](https://github.com/the-advoid/ad-void) via [**Aria compiler**](https://github.com/aria-toolkit) + [**ADBT**](https://github.com/adbt-lang) templates
