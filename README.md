...
<div data-no-restyle>
  ...
  <ul data-no-restyle>
    <li><a href="https://www.jsdelivr.com/package/gh/igorskyflyer/npm-scrollend-polyfill"><strong>Scrollend Polyfill</strong></a> – Powering <strong><code>3.975M</code> yearly requests</strong> with <code>+54,137%</code> <code>(~542×)</code> growth.</li>
...
- Published new releases of these npm packages:
  - [**TSConfig**](https://github.com/igorskyflyer/npm-tsconfig/releases/tag/v2.0.0) - `v2.0.0`
