...
### My tech stack
🌎 **Web**: _**HTML**_, _**CSS**_, _**JavaScript**_, _**jQuery**_, _**PHP**_, _**TypeScript**_, _**Node.js**_, _**Electron**_, _**MySQL**_, _**Wordpress + Woocommerce**_, _**React**_ (*soon* 😅), <br>
🖥️ **Desktop**: _**C#**_, _**C**_, _**Python**_, _**Java**_, _**Pascal**_, _**Delphi**_, <br>
