...
- Search `issues` to see if your question has already been answered.
...
- open a `new issue` using the appropriate issue template and with the label of `bug`,
...
Do so by:
- opening a `new issue` using the appropriate issue template and with the label of `feature`,
