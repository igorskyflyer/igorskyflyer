...
- Igor created an [**issue**](https://github.com/microsoft/vscode/issues/127201) at `microsoft/vscode` to override the native Save dialog interface. Following upstream architecture limitations, he engineered an independent API bypass ([**vscode-folderpicker**](https://github.com/igorskyflyer/npm-vscode-folderpicker)) and published a companion extension ([**New Folder**](https://github.com/igorskyflyer/vscode-new-folder)) to deliver the missing functionality &ndash; _Jun 26_.
